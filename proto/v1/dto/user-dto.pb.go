...
// source: proto/v1/dto/user-dto.proto
...
func (*ListUserReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_c0d50efeece0bfd6, []int{0}
}
...
func init() {
	proto.RegisterType((*ListUserReply)(nil), "dto.ListUserReply")
}

func init() { proto.RegisterFile("proto/v1/dto/user-dto.proto", fileDescriptor_c0d50efeece0bfd6) }

var fileDescriptor_c0d50efeece0bfd6 = []byte{
	// 168 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2e, 0x28, 0xca, 0x2f,
	0xc9, 0xd7, 0x2f, 0x33, 0xd4, 0x4f, 0x29, 0xc9, 0xd7, 0x2f, 0x2d, 0x4e, 0x2d, 0xd2, 0x4d, 0x29,
	0xc9, 0xd7, 0x03, 0x8b, 0x0a, 0x31, 0xa7, 0x94, 0xe4, 0x2b, 0x19, 0x73, 0xf1, 0xfa, 0x64, 0x16,
	0x97, 0x84, 0x16, 0xa7, 0x16, 0x05, 0xa5, 0x16, 0xe4, 0x54, 0x0a, 0xf1, 0x71, 0x31, 0x65, 0xa6,
	...
	0xe3, 0xe0, 0x81, 0x09, 0x9f, 0x00, 0x00, 0x00,
}
...
func (m *ListUserReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintUserDto(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
		i = encodeVarintUserDto(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func encodeVarintUserDto(dAtA []byte, offset int, v uint64) int {
	offset -= sovUserDto(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ListUserReply) Size() (n int) {
	...
	_ = l
	if m.Id != 0 {
		n += 1 + sovUserDto(uint64(m.Id))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovUserDto(uint64(l))
	}
	return n
}

func sovUserDto(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozUserDto(x uint64) (n int) {
	return sovUserDto(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ListUserReply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthUserDto
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipUserDto(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipUserDto(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowUserDto
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthUserDto
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupUserDto
			}
			depth--
		case 5:
			iNdEx += 4
